(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_eebf8e19._.js", {
        ...
        "MilestoneProvider.useEffect": ()=>{
            try {
                ...
                let updatedMilestones = [
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["milestones"]
                ];
                ...
                if (savedCodeSnippets) {
                    ...
                    updatedMilestones = updatedMilestones.map({
                        "MilestoneProvider.useEffect": (milestone)=>{
                            const saved = parsedCodeSnippets.find({
                                "MilestoneProvider.useEffect.saved": (s)=>s.id === milestone.id
                            }["MilestoneProvider.useEffect.saved"]);
                            return saved ? {
                                ...milestone,
                ...
                if (savedGithubResources) {
                    ...
                    updatedMilestones = updatedMilestones.map({
                        "MilestoneProvider.useEffect": (milestone)=>{
                            const saved = parsedGithubResources.find({
                                "MilestoneProvider.useEffect.saved": (s)=>s.id === milestone.id
                            }["MilestoneProvider.useEffect.saved"]);
                            return saved ? {
                                ...milestone,
...
_s(MilestoneProvider, "bPZK98XuCHk6Ji31dl/dTkvEuZo=");
...
//# sourceMappingURL=_eebf8e19._.js.map